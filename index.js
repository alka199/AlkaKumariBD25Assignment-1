...
function sortProductsByPricingHightoLow(product1, product2) {
  return product2.price - product1.price;
}
app.get("/products/sort/price-high-to-low", (req, res) => {
  let sortedProducts = products.slice();
  sortedProducts.sort(sortProductsByPricingHightoLow);
  res.json({ products: sortedProducts });
});

//Get the products sorted by “low-to-high” price
function sortProductsByPricingLowtoHigh(product1, product2) {
  return product1.price - product2.price;
}
app.get("/products/sort/price-low-to-high", (req, res) => {
  let sortedProducts = products.slice();
  sortedProducts.sort(sortProductsByPricingLowtoHigh);
  res.json({ products: sortedProducts });
});
